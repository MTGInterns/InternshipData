export default function category(){
    return (
      <div>
        <div className="container my-5 row gx-4">
          <div>
            <h2><b>Nature & Wildlife</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://keralaroutesuk.home.blog/wp-content/uploads/2019/07/explore-wildlife-sanctuaries-of-kerala-1.png" alt="Nature"/>
            </div>            
          </div>

          <div className="mt-5">
            <h2><b>Culture & Heritage</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://www.ritiriwaz.com/wp-content/uploads/2019/01/Kerala-culture.jpg" alt="cultural"/>
            </div>
          </div>

          <div className="mt-5">
            <h2><b>Beaches & Coastal</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/0e/01KovalamBeach%26Kerala.jpg"alt="beaches"/>
            </div>            
          </div>

          <div className="mt-5">
            <h2><b>Adventure & Activities</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://www.honeymoonbug.com/blog/wp-content/uploads/2022/03/Adventure-Activities-in-Kerala.jpg"alt="adventure"/>
            </div>
          </div>

          <div className="mt-5">
            <h2><b>Wellness & Ayurveda</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://www.ayurvedacollege.net/images/blogs/blog161.jpg"alt="wellness"/>
            </div>
          </div>

          <div className="mt-5">
            <h2><b>Pilgrimage & Spiritual</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://cdn.bluebirdtravels.in/wp-content/uploads/pilgrimage/kerala/pilgrimage-tourism-in-kerala-cover-pic-1140x530.jpg"alt="Pilgrimage"/>
            </div>
          </div>

          <div className="mt-5">
            <h2><b>Tea & Spice Tours</b></h2>
            <div className="card shadow-sm custom-hover mt-5" style={{cursor: "pointer", backgroundColor: "#fff8f8ff", width: "450px"}}>
                <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/06/6f/12/92.jpg"alt="tea"/>
            </div>
          </div>
        </div>
      </div>
